...
CACHE_HOME_DIR = os.path.join(XDG_CACHE_HOME, "harbour-pan-bikes")
CONFIG_HOME_DIR = os.path.join(XDG_CONFIG_HOME, "harbour-pan-bikes")
DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
DATA_HOME_DIR = os.path.join(XDG_DATA_HOME, "harbour-pan-bikes")
LOCALE_DIR = "/usr/share/harbour-pan-bikes/locale"
