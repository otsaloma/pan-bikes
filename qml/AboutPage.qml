    ...
    SilicaFlickable {
        ...
        Column {
            ...
            ListItemLabel {
                ...
                height: Theme.itemSizeExtraSmall
                horizontalAlignment: Text.AlignHCenter
                text: "Copyright © 2016–2018 Osmo Salomaa"
            }
            ...
            ListItemLabel {
                ...
                text: app.tr("Pan Bikes is free software released under the GNU General Public License (GPL), version 3 or later.")
